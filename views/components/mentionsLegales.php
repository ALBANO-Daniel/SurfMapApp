...
<main>
    <section>
        ...
        <p>
            Politique de confidentialité de Surf Spotlight

            La présente Politique de confidentialité décrit la façon dont vos informations personnelles sont recueillies, utilisées et partagées lorsque vous vous rendez sur surfspotlight.com (le « Site») ou que vous y effectuez un achat.
            ...
            NOUS CONTACTER
            Pour en savoir plus sur nos pratiques de confidentialité, si vous avez des questions ou si vous souhaitez déposer une réclamation, veuillez nous contacter par e-mail à deanidev@gmail.com, ou par courrier à l'adresse suivante:

            rue Henri Giffard, Amiens, 80090, France
        </p>
    </section>
