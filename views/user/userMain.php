<main class="container">
    ...
    <section class="container">
        <div class="row">
            ...
            <div class="col s12">
                <ul class="tabs">
                    <li class="tab col s4"><a href="#registerForm">Register</a></li>
                    <li class="tab col s4"><a class="active" href="#loginForm">Login In</a></li>
                    <li class="tab col s4"><a href="#contactUsForm">Contact Us</a></li>
                </ul>
            </div>
        </div>
    </section>
