    ...
    <section class="container center">
        <div class="container card">
            <nav class="col s12 light-blue darken-4">
                <h2 class="center ">nouveaux mot de passe</h2>
            </nav>
            <!-- error/sucess output  -->
            <?php
            if (SessionFlash::exist()) {
                ...
                <form id="changePasswordForm" action="" class="container" method="post" enctype="multipart/form-data">
                    <!-- password input  -->
                    <div class="row">
                    ...
                    <div class="row center-align">
                        <button class="unset"><a class="waves-effect waves-light btn">validé</a></button>
                    </div>
                </form>
        </div>
    </section>
